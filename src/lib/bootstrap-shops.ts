...
const defaultShops: DefaultShop[] = [
  {
    ...
    items: [
      ...
      {
        name: "五行种子·木",
        description: "适合在公会温室栽种，成熟后可收获木系材料。",
        category: "种植",
        price: 15,
        sortOrder: 10,
      },
      {
        name: "五行种子·火",
        description: "适合在公会温室栽种，成熟后可收获火系材料。",
        category: "种植",
        price: 15,
        sortOrder: 11,
      },
      {
        name: "五行种子·土",
        description: "适合在公会温室栽种，成熟后可收获土系材料。",
        category: "种植",
        price: 15,
        sortOrder: 12,
      },
      {
        name: "五行种子·金",
        description: "适合在公会温室栽种，成熟后可收获金系材料。",
        category: "种植",
        price: 15,
        sortOrder: 13,
      },
      {
        name: "五行种子·水",
        description: "适合在公会温室栽种，成熟后可收获水系材料。",
        category: "种植",
        price: 15,
        sortOrder: 14,
      },
